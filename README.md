...
(CRÍTICO) Desligar laboratório e sistemas não essenciais; redirecionar energia ao habitat e carregamento de baterias.
(CRÍTICO) Ativar canal de comunicação de emergência; aguardar janela de baixa radiação para restabelecer link.
(ALERTA) Reduzir atividades externas (EVA); monitorar dosimetria dos astronautas.
(ALERTA) Realizar verificação manual dos sensores do laboratório (inconsistência detectada).
---
